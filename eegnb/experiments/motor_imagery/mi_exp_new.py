...
import tkVideoPlayer as TKVideo

def run_popup(duration_minutes=10):
    root = tk.Tk()
    ...
    instruction_label = tk.Label(root, text="".format(TOTAL_DURATION), font=("Arial", 40), justify="center")
    instruction_label.pack(expand=True, fill='x')
...
class VisualFunni_select_unicorn(Experiment.BaseExperiment):
    ...
    def run(self, instructions=True):
        ...
        gui_thread.start()
        print(f"GUI thread started for {self.DURATION_MINUTES} minutes")
